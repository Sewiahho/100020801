...
在第35篇文章[《join语句怎么优化？》][join]中，我在介绍join执行顺序的时候，用的都是straight\_join。@郭健 同学在文后提出了两个问题：
...
![871f890532349781fdc4a4287e9f91bd.png][]
...
![b7f27917ceb0be90ef7b201f2794c817.png][]
...
![8fd4b4b179fb84caaecece84b6406ad7.jpg][]
...
![f5712c56dc84d331990409a5c313ea9c.png][]
...
![d74878e7469edb8b713a18c6158530ab.png][]
...
![d9952e4c2150bc649c7f2977e6ea80f5.png][]
...
我们知道，join语句使用不同的算法，对语句的性能影响会很大。在第34篇文章[《到底可不可以使用join？》][join 1]的评论区中，@书策稠浊 和 @朝夕心 两位同学提了一个很不错的问题。
...
1.  在对被驱动表做全表扫描的时候，如果数据没有在Buffer Pool中，就需要等待这部分数据从磁盘读入；
    从磁盘读入数据到内存中，会影响正常业务的Buffer Pool命中率，而且这个算法天然会对被驱动表的数据做多次访问，更容易将这些数据页放到Buffer Pool的头部（请参考[第35篇文章][join]中的相关内容)；
...
在第37篇文章[《什么时候会使用内部临时表？》][Link 1]中，@老杨同志 提了一个好问题：如果只需要去重，不需要执行聚合函数，distinct 和group by哪种效率高一些呢？
...
> 备注：这里你可以顺便复习一下[第37篇文章][Link 1]中关于group by的相关内容。
...
除了性能问题，大家对细节的追问也很到位。在第39篇文章[《自增主键为什么不是连续的？》][Link 2]评论区，@帽子掉了 同学问到：在binlog\_format=statement时，语句A先获取id=1，然后语句B获取id=2；接着语句B提交，写binlog，然后语句A再写binlog。这时候，如果binlog重放，是不是会发生语句B的id为1，而语句A的id为2的不一致情况呢？
...
![b55b2167aa301d899ccc86a00b496b25.png][]
...
[join]: https://time.geekbang.org/column/article/80147
[871f890532349781fdc4a4287e9f91bd.png]: https://static001.geekbang.org/resource/image/87/bd/871f890532349781fdc4a4287e9f91bd.png
[b7f27917ceb0be90ef7b201f2794c817.png]: https://static001.geekbang.org/resource/image/b7/17/b7f27917ceb0be90ef7b201f2794c817.png
[8fd4b4b179fb84caaecece84b6406ad7.jpg]: https://static001.geekbang.org/resource/image/8f/d7/8fd4b4b179fb84caaecece84b6406ad7.jpg
[f5712c56dc84d331990409a5c313ea9c.png]: https://static001.geekbang.org/resource/image/f5/9c/f5712c56dc84d331990409a5c313ea9c.png
[d74878e7469edb8b713a18c6158530ab.png]: https://static001.geekbang.org/resource/image/d7/ab/d74878e7469edb8b713a18c6158530ab.png
[d9952e4c2150bc649c7f2977e6ea80f5.png]: https://static001.geekbang.org/resource/image/d9/f5/d9952e4c2150bc649c7f2977e6ea80f5.png
[join 1]: https://time.geekbang.org/column/article/79700
[Link 1]: https://time.geekbang.org/column/article/80477
[Link 2]: https://time.geekbang.org/column/article/80531
[b55b2167aa301d899ccc86a00b496b25.png]: https://static001.geekbang.org/resource/image/b5/25/b55b2167aa301d899ccc86a00b496b25.png
[8]: https://time.geekbang.org/column/article/70562
