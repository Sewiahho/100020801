...
如果新增的SQL语句不多，手动跑一下就可以。而如果是新项目的话，或者是修改了原有项目的 表结构设计，全量回归测试都是必要的。这时候，你需要工具帮你检查所有的SQL语句的返回结果。比如，你可以使用开源工具pt-query-digest\([https://www.percona.com/doc/percona-toolkit/3.0/pt-query-digest.html\)。](https://www.percona.com/doc/percona-toolkit/3.0/pt-query-digest.html%29。)
...
!\[3a7578e104612a188a2d574eaa3bd81e.png\]\[\] 我们用上一篇的加锁规则来分析一下，看看session A的select语句加了哪些锁：
